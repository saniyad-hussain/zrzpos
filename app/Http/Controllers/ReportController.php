...
class ReportController extends Controller
{
    ...
    public function monthlySaleByWarehouse(Request $request, $year)
    {
        ...
        while($start <= $end)
        {
            ...
            $sale_q = Sale::where('warehouse_id', $data['warehouse_id'])->whereDate('created_at', '>=' , $start_date)->whereDate('created_at', '<=' , $end_date);
                    ...
                    foreach ($variant_id_all as $item_code => $variant_id) {
                        ...
                        $nestedData['returned_amount'] = DB::table('returns')
                                ...
                                ->where([
                                  ...
                                  ->sum(DB::raw('product_returns.total / returns.exchange_rate'));
                        ...
                        $nestedData['purchase_returned_amount'] = DB::table('return_purchases')
                                ...
                                ->where([
                                  ...
                                  ->sum(DB::raw('purchase_product_return.total / return_purchases.exchange_rate'));
